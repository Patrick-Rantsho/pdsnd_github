...
def get_filters():
    ...
    month = input('Provide a month name: '\
                    'or just say \'all\' to apply no month filter. \n> ')

    # get user input for day of week (all, monday, tuesday, ... sunday)
    day = input('Provide the week day you want to analyze:'\
...
def table_stats(df, city):
    ...
    # count the number of missing values in the User Type column
...
def main():
    while True:
        ...
        if restart.lower() != 'yes':
            break
        print("Good! Provide Answers Again")
